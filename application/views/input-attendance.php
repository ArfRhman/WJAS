...
<body>
						...
						<div class="module-body">
							<div class="control-group">
								<div class="controls row-fluid">
									<select id="basicinput" class="span12">
	...
	<script src="<?php echo base_url()?>resources/scripts/jquery-1.9.1.min.js" type="text/javascript"></script>
	<script src="<?php echo base_url()?>resources/scripts/jquery-ui-1.10.1.custom.min.js" type="text/javascript"></script>
